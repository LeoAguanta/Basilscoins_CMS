    ...
    public class Province: BaseModule
    {
        ...
        public override ReturnSet LoadList()
        {
            ...
            try
            {
                ...
                {
                    var data = db.QueryTable<tProvince>("(select * from dbo.tProvince)a", to);
        ...
        public override ReturnSet LoadForm()
        {
            ...
            try
            {
                using (var db = new ProvinceDb(Session))
                {
                    var data = db.Single<tProvince>("select * from dbo.tProvince where ID = {0}", Parameter["ID"].IsNull(0).ToInt32());
        ...
        public override ReturnSet Save()
        {
            ...
            try
            {
                using (var db = new ProvinceDb(Session))
                {
                    tProvince tfm = Parameter["Data"].ToObject<tProvince>();
        ...
        public override ReturnSet DeleteRecord()
        {
            ...
            try
            {
                using (var db = new ProvinceDb(Session))
                {
                    ...
                    {
                        var record = db.Single<tProvince>("select * from dbo.tProvince where ID = {0} and ID > 1", id);
